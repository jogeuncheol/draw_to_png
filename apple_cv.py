...
contours2, _ = cv.findContours(binary2, cv.RETR_TREE, cv.CHAIN_APPROX_NONE)
...
resolution = [find_min_max_coordinate(find_coord, 'x'), find_min_max_coordinate(find_coord, 'y')]
print(resolution)
